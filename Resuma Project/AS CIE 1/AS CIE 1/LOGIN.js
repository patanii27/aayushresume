...
function register () {
  ...
  moblieno= document.getElementById('moblieno').value
  id = document.getElementById('id').value

  
  if (validate_field(full_name) == false || validate_field(moblieno) == false || validate_field(id) == false) {
...
function login () {
  ...
  .then(function() {
    ...
    if (domain === 'dr.ac') {
      window.location.href = "dr.html"; // Redirect to doctor dashboard
    } else if (domain === 'ad.ac') {
